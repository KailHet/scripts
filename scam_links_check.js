...
for (let index = 0; index < links.length; index++) {
  if (msg.content.includes(links[index])) {
    msg.channel.send(`Пользователь ${msg.author} отправил скам-ссылку! Она была удалена.`)
    msg.delete()
    console.log(`<font color="yellow">Пользователь ${msg.author.tag} отправил скам-ссылку на сервере ${msg.guild.name}</font>`);
  }
}
